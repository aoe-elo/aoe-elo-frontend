...
import type { Achievement, AchievementId } from "./achievement.model";
...
export type AchievableOptionalAttributes =
	| "achievement_id"
	| "hidden"
	| "created_at"
	| "updated_at"
	| "deleted_at";
export type AchievableCreationAttributes = Optional<
	IAchievableAttributes,
	AchievableOptionalAttributes
>;

export class Achievable
	extends Model<IAchievableAttributes, AchievableCreationAttributes>
	implements IAchievableAttributes
{
	declare id: number;
	...
	setAchievement!: Sequelize.BelongsToSetAssociationMixin<
		Achievement,
		AchievementId
	>;
