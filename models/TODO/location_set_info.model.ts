...
export type LocationSetInfoOptionalAttributes =
	| "set_info_id"
	| "location_id"
	| "created_at"
	| "updated_at"
	| "deleted_at";
export type LocationSetInfoCreationAttributes = Optional<
	ILocationSetInfoAttributes,
	LocationSetInfoOptionalAttributes
>;

export class LocationSetInfo
	extends Model<ILocationSetInfoAttributes, LocationSetInfoCreationAttributes>
	implements ILocationSetInfoAttributes
{
	declare id: number;
