...
export type CacheMostVisitedOptionalAttributes =
	| "entity_id"
	| "created_at"
	| "updated_at";
export type CacheMostVisitedCreationAttributes = Optional<
	ICacheMostVisitedAttributes,
	CacheMostVisitedOptionalAttributes
>;

export class CacheMostVisited
	extends Model<ICacheMostVisitedAttributes, CacheMostVisitedCreationAttributes>
	implements ICacheMostVisitedAttributes
{
	declare id: number;
	declare page: string;
