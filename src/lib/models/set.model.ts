...
import type { Elo1V1Cache, Elo1V1CacheId } from "./elo_1v1_cache.model";
import type { RatingDelta, RatingDeltaId } from "./rating_delta.model";
import type { SetInfo, SetInfoId } from "./set_info.model";
import type { Stageable, StageableId } from "./stageable.model";
...
export type SetOptionalAttributes =
	| "is_tie"
	| "has_admin_win"
	| "played_at"
	| "use_played_at_dummy"
	...
	| "updated_at"
	| "deleted_at";
export type SetCreationAttributes = Optional<
	ISetAttributes,
	SetOptionalAttributes
>;

export class Set
	extends Model<ISetAttributes, SetCreationAttributes>
	implements ISetAttributes
{
	declare id: number;
	...
	setElo_1_v_1_caches!: Sequelize.HasManySetAssociationsMixin<
		Elo1V1Cache,
		Elo1V1CacheId
	>;
	addElo_1_v_1_cach!: Sequelize.HasManyAddAssociationMixin<
		Elo1V1Cache,
		Elo1V1CacheId
	>;
	addElo_1_v_1_caches!: Sequelize.HasManyAddAssociationsMixin<
		Elo1V1Cache,
		Elo1V1CacheId
	>;
	createElo_1_v_1_cach!: Sequelize.HasManyCreateAssociationMixin<Elo1V1Cache>;
	removeElo_1_v_1_cach!: Sequelize.HasManyRemoveAssociationMixin<
		Elo1V1Cache,
		Elo1V1CacheId
	>;
	removeElo_1_v_1_caches!: Sequelize.HasManyRemoveAssociationsMixin<
		Elo1V1Cache,
		Elo1V1CacheId
	>;
	hasElo_1_v_1_cach!: Sequelize.HasManyHasAssociationMixin<
		Elo1V1Cache,
		Elo1V1CacheId
	>;
	hasElo_1_v_1_caches!: Sequelize.HasManyHasAssociationsMixin<
		Elo1V1Cache,
		Elo1V1CacheId
	>;
	...
	setRating_delta!: Sequelize.HasManySetAssociationsMixin<
		RatingDelta,
		RatingDeltaId
	>;
	addRating_deltum!: Sequelize.HasManyAddAssociationMixin<
		RatingDelta,
		RatingDeltaId
	>;
	addRating_delta!: Sequelize.HasManyAddAssociationsMixin<
		RatingDelta,
		RatingDeltaId
	>;
	createRating_deltum!: Sequelize.HasManyCreateAssociationMixin<RatingDelta>;
	removeRating_deltum!: Sequelize.HasManyRemoveAssociationMixin<
		RatingDelta,
		RatingDeltaId
	>;
	removeRating_delta!: Sequelize.HasManyRemoveAssociationsMixin<
		RatingDelta,
		RatingDeltaId
	>;
	hasRating_deltum!: Sequelize.HasManyHasAssociationMixin<
		RatingDelta,
		RatingDeltaId
	>;
	hasRating_delta!: Sequelize.HasManyHasAssociationsMixin<
		RatingDelta,
		RatingDeltaId
	>;
	...
	removeSet_infos!: Sequelize.HasManyRemoveAssociationsMixin<
		SetInfo,
		SetInfoId
	>;
				...
				indexes: [
					{
						...
						unique: true,
						fields: [{ name: "aoe2cm2_civ_draft_link" }],
					},
					{
						name: "sets_aoe2cm2_map_draft_link_unique",
						unique: true,
						fields: [{ name: "aoe2cm2_map_draft_link" }],
					},
				],
			},
		) as typeof Set;
