...
export type FailedJobCreationAttributes = Optional<
	IFailedJobAttributes,
	FailedJobOptionalAttributes
>;

export class FailedJob
	extends Model<IFailedJobAttributes, FailedJobCreationAttributes>
	implements IFailedJobAttributes
{
	declare id: number;
	declare uuid: string;
