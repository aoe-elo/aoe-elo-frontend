...
import { AutoIncrement, Table, Column, Model, Default, PrimaryKey, Unique, AllowNull, DataType, HasMany, UpdatedAt, CreatedAt } from 'sequelize-typescript';
...
export default class AtpCategory extends Model<IAtpCategoryAttributes, AtpCategoryCreationAttributes> implements IAtpCategoryAttributes {
  @Column
  @PrimaryKey
  @AutoIncrement
  @AllowNull(false)
