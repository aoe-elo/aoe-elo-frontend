...
export type StageableOptionalAttributes =
	| "stage_order"
	| "created_at"
	| "updated_at"
	| "deleted_at";
export type StageableCreationAttributes = Optional<
	IStageableAttributes,
	StageableOptionalAttributes
>;

export class Stageable
	extends Model<IStageableAttributes, StageableCreationAttributes>
	implements IStageableAttributes
{
	declare id: number;
