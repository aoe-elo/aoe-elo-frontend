...
export type LocationStyleOptionalAttributes =
	| "weight"
	| "created_at"
	| "updated_at"
	| "deleted_at";
export type LocationStyleCreationAttributes = Optional<
	ILocationStyleAttributes,
	LocationStyleOptionalAttributes
>;

export class LocationStyle
	extends Model<ILocationStyleAttributes, LocationStyleCreationAttributes>
	implements ILocationStyleAttributes
{
	declare id: number;
