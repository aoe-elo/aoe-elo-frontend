...
export type Elo1V1CacheOptionalAttributes =
	| "type"
	| "tournament_id"
	| "set_id"
	| "created_at"
	| "updated_at";
export type Elo1V1CacheCreationAttributes = Optional<
	IElo1V1CacheAttributes,
	Elo1V1CacheOptionalAttributes
>;

export class Elo1V1Cache
	extends Model<IElo1V1CacheAttributes, Elo1V1CacheCreationAttributes>
	implements IElo1V1CacheAttributes
{
	declare id: number;
	declare type: string;
