...
export type AchievementOptionalAttributes =
	| "name_short"
	| "description"
	| "image_path"
	| "created_at"
	| "updated_at"
	| "deleted_at";
export type AchievementCreationAttributes = Optional<
	IAchievementAttributes,
	AchievementOptionalAttributes
>;

export class Achievement
	extends Model<IAchievementAttributes, AchievementCreationAttributes>
	implements IAchievementAttributes
{
	declare id: number;
	declare name: string;
	...
	setAchievables!: Sequelize.HasManySetAssociationsMixin<
		Achievable,
		AchievableId
	>;
	addAchievable!: Sequelize.HasManyAddAssociationMixin<
		Achievable,
		AchievableId
	>;
	addAchievables!: Sequelize.HasManyAddAssociationsMixin<
		Achievable,
		AchievableId
	>;
	createAchievable!: Sequelize.HasManyCreateAssociationMixin<Achievable>;
	removeAchievable!: Sequelize.HasManyRemoveAssociationMixin<
		Achievable,
		AchievableId
	>;
	removeAchievables!: Sequelize.HasManyRemoveAssociationsMixin<
		Achievable,
		AchievableId
	>;
	hasAchievable!: Sequelize.HasManyHasAssociationMixin<
		Achievable,
		AchievableId
	>;
	hasAchievables!: Sequelize.HasManyHasAssociationsMixin<
		Achievable,
		AchievableId
	>;
