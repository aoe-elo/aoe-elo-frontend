...
export type SetInfoOptionalAttributes =
	| "is_winner"
	| "created_at"
	| "updated_at"
	| "deleted_at";
export type SetInfoCreationAttributes = Optional<
	ISetInfoAttributes,
	SetInfoOptionalAttributes
>;

export class SetInfo
	extends Model<ISetInfoAttributes, SetInfoCreationAttributes>
	implements ISetInfoAttributes
{
	declare id: number;
