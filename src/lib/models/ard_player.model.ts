...
import { AutoIncrement, Table, Column, Model, PrimaryKey, Unique, AllowNull, DataType, BelongsTo, ForeignKey, DeletedAt, UpdatedAt, CreatedAt, HasOne, BelongsToMany } from 'sequelize-typescript';
...
export default class ArdPlayer extends Model<IArdPlayerAttributes, ArdPlayerCreationAttributes> implements IArdPlayerAttributes {
  ...
  @BelongsToMany(() => ArdTeam, () => ArdPlayerArdTeam)
