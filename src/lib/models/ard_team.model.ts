...
import { AutoIncrement, BelongsToMany, Table, Column, Model, PrimaryKey, AllowNull, DataType, BelongsTo, DeletedAt, UpdatedAt, CreatedAt } from 'sequelize-typescript';
...
export default class ArdTeam extends Model<IArdTeamAttributes, ArdTeamCreationAttributes> implements IArdTeamAttributes {
  ...
  @BelongsToMany(() => ArdPlayer, () => ArdPlayerArdTeam)
