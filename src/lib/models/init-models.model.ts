...
import type { IAchievableAttributes, AchievableCreationAttributes } from "./achievable.model";
import { Achievement as _Achievement } from "./achievement.model";
import type { IAchievementAttributes, AchievementCreationAttributes } from "./achievement.model";
import { Actionlog as _Actionlog } from "./actionlog.model";
import type { IActionlogAttributes, ActionlogCreationAttributes } from "./actionlog.model";
import { Action as _Action } from "./action.model";
import type { IActionAttributes, ActionCreationAttributes } from "./action.model";
import { ArdPlayerArdTeam as _ArdPlayerArdTeam } from "./ard_player_ard_team.model";
import type { IArdPlayerArdTeamAttributes, ArdPlayerArdTeamCreationAttributes } from "./ard_player_ard_team.model";
import { ArdPlayer as _ArdPlayer } from "./ard_player.model";
import type { IArdPlayerAttributes, ArdPlayerCreationAttributes } from "./ard_player.model";
import { ArdTeam as _ArdTeam } from "./ard_team.model";
import type { IArdTeamAttributes, ArdTeamCreationAttributes } from "./ard_team.model";
import { AtpCategory as _AtpCategory } from "./atp_category.model";
import type { IAtpCategoryAttributes, AtpCategoryCreationAttributes } from "./atp_category.model";
...
import type { ICacheLockAttributes, CacheLockCreationAttributes } from "./cache_lock.model";
import { CacheMostVisited as _CacheMostVisited } from "./cache_most_visited.model";
import type { ICacheMostVisitedAttributes, CacheMostVisitedCreationAttributes } from "./cache_most_visited.model";
import { Country as _Country } from "./country.model";
import type { ICountryAttributes, CountryCreationAttributes } from "./country.model";
import { DiscordUser as _DiscordUser } from "./discord_user.model";
import type { IDiscordUserAttributes, DiscordUserCreationAttributes } from "./discord_user.model";
import { Elo1V1Cache as _Elo1V1Cache } from "./elo_1v1_cache.model";
import type { IElo1V1CacheAttributes, Elo1V1CacheCreationAttributes } from "./elo_1v1_cache.model";
import { ExternDeCache as _ExternDeCache } from "./extern_de_cache.model";
import type { IExternDeCacheAttributes, ExternDeCacheCreationAttributes } from "./extern_de_cache.model";
import { ExternVooblyCache as _ExternVooblyCache } from "./extern_voobly_cache.model";
import type { IExternVooblyCacheAttributes, ExternVooblyCacheCreationAttributes } from "./extern_voobly_cache.model";
import { ExternVooblyPlayerCache as _ExternVooblyPlayerCache } from "./extern_voobly_player_cache.model";
import type { IExternVooblyPlayerCacheAttributes, ExternVooblyPlayerCacheCreationAttributes } from "./extern_voobly_player_cache.model";
import { FailedJob as _FailedJob } from "./failed_job.model";
import type { IFailedJobAttributes, FailedJobCreationAttributes } from "./failed_job.model";
import { GithubUser as _GithubUser } from "./github_user.model";
import type { IGithubUserAttributes, GithubUserCreationAttributes } from "./github_user.model";
...
import type { ILocationLocationStyleAttributes, LocationLocationStyleCreationAttributes } from "./location_location_style.model";
import { LocationSetInfo as _LocationSetInfo } from "./location_set_info.model";
import type { ILocationSetInfoAttributes, LocationSetInfoCreationAttributes } from "./location_set_info.model";
import { LocationStyle as _LocationStyle } from "./location_style.model";
import type { ILocationStyleAttributes, LocationStyleCreationAttributes } from "./location_style.model";
import { Location as _Location } from "./location.model";
import type { ILocationAttributes, LocationCreationAttributes } from "./location.model";
import { MetaCache as _MetaCache } from "./meta_cache.model";
import type { IMetaCacheAttributes, MetaCacheCreationAttributes } from "./meta_cache.model";
import { Metadatum as _Metadatum } from "./metadatum.model";
import type { IMetadatumAttributes, MetadatumCreationAttributes } from "./metadatum.model";
import { Migrationlog as _Migrationlog } from "./migrationlog.model";
import type { IMigrationlogAttributes, MigrationlogCreationAttributes } from "./migrationlog.model";
import { ModelHasPermission as _ModelHasPermission } from "./model_has_permission.model";
import type { IModelHasPermissionAttributes, ModelHasPermissionCreationAttributes } from "./model_has_permission.model";
import { ModelHasRole as _ModelHasRole } from "./model_has_role.model";
import type { IModelHasRoleAttributes, ModelHasRoleCreationAttributes } from "./model_has_role.model";
...
import type { IPasswordResetTokenAttributes, PasswordResetTokenCreationAttributes } from "./password_reset_token.model";
import { Permission as _Permission } from "./permission.model";
import type { IPermissionAttributes, PermissionCreationAttributes } from "./permission.model";
import { PersonalAccessToken as _PersonalAccessToken } from "./personal_access_token.model";
import type { IPersonalAccessTokenAttributes, PersonalAccessTokenCreationAttributes } from "./personal_access_token.model";
import { PlayerTeam as _PlayerTeam } from "./player_team.model";
import type { IPlayerTeamAttributes, PlayerTeamCreationAttributes } from "./player_team.model";
import { Player as _Player } from "./player.model";
import type { IPlayerAttributes, PlayerCreationAttributes } from "./player.model";
import { RatingCheckpoint as _RatingCheckpoint } from "./rating_checkpoint.model";
import type { IRatingCheckpointAttributes, RatingCheckpointCreationAttributes } from "./rating_checkpoint.model";
import { RatingDelta as _RatingDelta } from "./rating_delta.model";
import type { IRatingDeltaAttributes, RatingDeltaCreationAttributes } from "./rating_delta.model";
import { Review as _Review } from "./review.model";
import type { IReviewAttributes, ReviewCreationAttributes } from "./review.model";
import { RoleHasPermission as _RoleHasPermission } from "./role_has_permission.model";
import type { IRoleHasPermissionAttributes, RoleHasPermissionCreationAttributes } from "./role_has_permission.model";
...
import type { ISessionAttributes, SessionCreationAttributes } from "./session.model";
import { SetInfo as _SetInfo } from "./set_info.model";
import type { ISetInfoAttributes, SetInfoCreationAttributes } from "./set_info.model";
...
import type { IStageTournamentTemplateAttributes, StageTournamentTemplateCreationAttributes } from "./stage_tournament_template.model";
import { Stageable as _Stageable } from "./stageable.model";
import type { IStageableAttributes, StageableCreationAttributes } from "./stageable.model";
...
import type { ISteamUserAttributes, SteamUserCreationAttributes } from "./steam_user.model";
...
import type { ITelemetryAttributes, TelemetryCreationAttributes } from "./telemetry.model";
import { TournamentResult as _TournamentResult } from "./tournament_result.model";
import type { ITournamentResultAttributes, TournamentResultCreationAttributes } from "./tournament_result.model";
import { Tournament as _Tournament } from "./tournament.model";
import type { ITournamentAttributes, TournamentCreationAttributes } from "./tournament.model";
import { TwitchUser as _TwitchUser } from "./twitch_user.model";
import type { ITwitchUserAttributes, TwitchUserCreationAttributes } from "./twitch_user.model";
