...
export type MigrationlogOptionalAttributes =
	| "save_confirmed"
	| "created_at"
	| "updated_at";
export type MigrationlogCreationAttributes = Optional<
	IMigrationlogAttributes,
	MigrationlogOptionalAttributes
>;

export class Migrationlog
	extends Model<IMigrationlogAttributes, MigrationlogCreationAttributes>
	implements IMigrationlogAttributes
{
	declare id: number;
