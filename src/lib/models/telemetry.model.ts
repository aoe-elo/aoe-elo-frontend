...
export type TelemetryCreationAttributes = Optional<
	ITelemetryAttributes,
	TelemetryOptionalAttributes
>;

export class Telemetry
	extends Model<ITelemetryAttributes, TelemetryCreationAttributes>
	implements ITelemetryAttributes
{
	declare id: number;
