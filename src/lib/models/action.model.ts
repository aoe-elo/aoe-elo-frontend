...
export type ActionOptionalAttributes =
	| "description"
	| "created_at"
	| "updated_at"
	| "deleted_at";
export type ActionCreationAttributes = Optional<
	IActionAttributes,
	ActionOptionalAttributes
>;

export class Action
	extends Model<IActionAttributes, ActionCreationAttributes>
	implements IActionAttributes
{
	declare id: number;
	declare name: string;
	...
	removeActionlog!: Sequelize.HasManyRemoveAssociationMixin<
		Actionlog,
		ActionlogId
	>;
	removeActionlogs!: Sequelize.HasManyRemoveAssociationsMixin<
		Actionlog,
		ActionlogId
	>;
