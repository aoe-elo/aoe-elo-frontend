...
import { AutoIncrement, Table, Column, Model, PrimaryKey, Unique, AllowNull, DataType, BelongsTo, ForeignKey, DeletedAt, UpdatedAt, CreatedAt } from 'sequelize-typescript';
...
export default class User extends Model<IUserAttributes, UserCreationAttributes> implements IUserAttributes {
  @Column
  @PrimaryKey
  @AutoIncrement
  @AllowNull(false)
