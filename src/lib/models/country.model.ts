...
import { AutoIncrement, Table, Column, Model, Default, PrimaryKey, AllowNull, DataType, HasMany } from 'sequelize-typescript';
...
export default class Country extends Model<ICountryAttributes, CountryCreationAttributes> implements ICountryAttributes {
  @Column
  @PrimaryKey
  @AutoIncrement
  @AllowNull(false)
