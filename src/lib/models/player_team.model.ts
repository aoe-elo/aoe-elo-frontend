...
import { AutoIncrement, Table, Column, Model, Default, PrimaryKey, AllowNull, DataType, ForeignKey, DeletedAt, UpdatedAt, CreatedAt } from 'sequelize-typescript';
...
export default class PlayerTeam extends Model<IPlayerTeamAttributes, PlayerTeamCreationAttributes> implements IPlayerTeamAttributes {
