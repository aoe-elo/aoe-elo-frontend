...
import type { RoleHasPermission, RoleHasPermissionId } from './role_has_permission.model';
...
export class Role extends Model<IRoleAttributes, RoleCreationAttributes> implements IRoleAttributes {
  ...
  addModel_has_role!: Sequelize.HasManyAddAssociationMixin<ModelHasRole, ModelHasRoleId>;
  addModel_has_roles!: Sequelize.HasManyAddAssociationsMixin<ModelHasRole, ModelHasRoleId>;
  createModel_has_role!: Sequelize.HasManyCreateAssociationMixin<ModelHasRole>;
  removeModel_has_role!: Sequelize.HasManyRemoveAssociationMixin<ModelHasRole, ModelHasRoleId>;
  removeModel_has_roles!: Sequelize.HasManyRemoveAssociationsMixin<ModelHasRole, ModelHasRoleId>;
