...
export type StageOptionalAttributes =
	| "bracket"
	| "default_order"
	| "weight"
	| "importance"
...
export type StageCreationAttributes = Optional<
	IStageAttributes,
	StageOptionalAttributes
>;

export class Stage
	extends Model<IStageAttributes, StageCreationAttributes>
	implements IStageAttributes
{
	...
	removeStageable!: Sequelize.HasManyRemoveAssociationMixin<
		Stageable,
		StageableId
	>;
	removeStageables!: Sequelize.HasManyRemoveAssociationsMixin<
		Stageable,
		StageableId
	>;
