export interface IBaseRepositoryInterface<Id, Data> {
    ...
    create(details: Partial<Data>, user_id: number, actionlog_summary: string): Promise<Id>;
    update(id: Id, new_details: Partial<Data>, user_id: number, actionlog_summary: string): Promise<boolean>;
